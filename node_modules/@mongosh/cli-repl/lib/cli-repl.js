...
class CliRepl {
    ...
    async start(driverUri, driverOptions) {
        ...
        logging_1.setupLoggerAndTelemetry(this.bus, logger, this.toggleableAnalytics, {
    ...
    async connect(driverUri, driverOptions) {
        if (!this.cliOptions.nodb && !this.cliOptions.quiet) {
            this.output.write(i18n_1.default.__(CONNECTING) + '\t\t' + this.clr(history_1.redactURICredentials(driverUri), 'mongosh:uri') + '\n');
        }
